...
const DeclarationTimeMap = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_s(({ timeHeatmap, data })=>{
    _s();
    ...
    const selectedContainers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DeclarationTimeMap.useMemo[selectedContainers]": ()=>{
            if (selectedHour === null) return [];
            return data.filter({
                "DeclarationTimeMap.useMemo[selectedContainers]": (d)=>{
...
}, "3ViSwuAH9vXcb1pqVhkIW1MuWeA="));
_c = DeclarationTimeMap;
function Analytics({ data }) {
    _s1();
    // ── Optimized Single-Pass Data Processing ──
    const { histogram, origins, weightData, dwellData, regimeData, offHoursData, vpkData, hsData, timeHeatmap, kpis } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Analytics.useMemo": ()=>{
            // Initialize structures
            const hist = Array.from({
                length: 10
            }, {
                "Analytics.useMemo.hist": (_, i)=>({
                        range: `${(i * 0.1).toFixed(1)}-${((i + 1) * 0.1).toFixed(1)}`,
                        count: 0,
                        low: i * 0.1
                    })
            }["Analytics.useMemo.hist"]);
            const originMap = {};
            const weights = [];
            const dwellBuckets = [
                {
            ...
            const hoursHeatmap = Array.from({
                ...
                "Analytics.useMemo.hoursHeatmap": (_, i)=>({
                        hour: i,
            ...
            }["Analytics.useMemo.hoursHeatmap"]);
            ...
            // Post-processing
            const topOrigins = Object.entries(originMap).map({
                "Analytics.useMemo.topOrigins": ([country, count])=>({
                        country,
                        count
                    })
            }["Analytics.useMemo.topOrigins"]).sort({
                "Analytics.useMemo.topOrigins": (a, b)=>b.count - a.count
            }["Analytics.useMemo.topOrigins"]).slice(0, 10);
            ...
            if (weights.length > MAX_POINTS) {
                ...
                sampledWeights = weights.filter({
                    "Analytics.useMemo": (_, i)=>i % step === 0
                }["Analytics.useMemo"]);
            }
            const topHS = Object.values(hsMap).map({
                "Analytics.useMemo.topHS": (h)=>({
                        ...h,
                        avgRisk: parseFloat((h.sumRisk / h.total).toFixed(3))
                    })
            }["Analytics.useMemo.topHS"]).sort({
                "Analytics.useMemo.topHS": (a, b)=>b.avgRisk - a.avgRisk
            }["Analytics.useMemo.topHS"]).slice(0, 10);
            hoursHeatmap.forEach({
                "Analytics.useMemo": (h)=>{
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DeclarationTimeMap, {
...
_s1(Analytics, "+uo262GnV0qPRpwQwKkc8ET59RI=");
_c1 = Analytics;
var _c, _c1;
__turbopack_context__.k.register(_c, "DeclarationTimeMap");
...
function App() {
    ...
    const handleThresholdChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[handleThresholdChange]": (newThreshold)=>{
            ...
            setData({
                "App.useCallback[handleThresholdChange]": (prev)=>{
                    const updated = prev.map({
                        "App.useCallback[handleThresholdChange].updated": (row)=>{
                    ...
                    }["App.useCallback[handleThresholdChange].updated"]);
    ...
    const handleLogin = (loggedUser)=>{
        ...
        setLoadMsg('Fetching Intelligence Data...');
        Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getStats().catch(()=>null),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getResults(1, 100).catch(()=>null)
...
_s(App, "bwMF4RVGTCdbK6vqgfFyYaXUXBU=");
_c1 = App;
var _c, _c1;
