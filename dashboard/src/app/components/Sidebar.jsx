        ...
        <div style={{
            ...
            <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#F5F0E8', padding: '12px', borderRadius: 8, border: '1px solid #EDE7DB' }}>
                    ...
                    <div style={{ flex: 1 }}>
                        <div style={{ fontFamily: 'Quicksand', fontSize: 13, fontWeight: 700, color: '#2C2418' }}>{userId?.username || 'OFFICER_XYZ'}</div>
                        <div style={{ fontFamily: 'Quicksand', fontSize: 11, color: '#7A6E5D', fontWeight: 500 }}>Role: {userId?.role?.toUpperCase() || 'OFFICER'}</div>
                    </div>
                </div>
            </div>
